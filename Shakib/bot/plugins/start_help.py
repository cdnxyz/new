# (c) Shakib-goel 
from Shakib.bot import StreamBot
from Shakib.vars import Var
import logging
logger = logging.getLogger(__name__)
from Shakib.bot.plugins.stream import MY_PASS
from Shakib.utils.human_readable import humanbytes
from Shakib.utils.database import Database
from pyrogram import filters
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton
from pyrogram.errors import UserNotParticipant
from Shakib.utils.file_properties import get_name, get_hash, get_media_file_size
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Support](https://t.me/expertskb).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ Owner", url="https://github.com/expertskb")],
            ]
        )
    )
